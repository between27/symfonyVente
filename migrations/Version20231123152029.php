 ...
 */
final class Version20231123152029 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE burger (id INT AUTO_INCREMENT NOT NULL, image_id INT DEFAULT NULL, pain_id INT DEFAULT NULL, oignon_id INT DEFAULT NULL, sauce_id INT DEFAULT NULL, commentaire_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_EFE35A0D3DA5256D (image_id), UNIQUE INDEX UNIQ_EFE35A0D64775A84 (pain_id), INDEX IDX_EFE35A0D8F038184 (oignon_id), INDEX IDX_EFE35A0D7AB984B7 (sauce_id), UNIQUE INDEX UNIQ_EFE35A0DBA9CD190 (commentaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
